          ...
          <View style={{ 
            ...
            >
              <View className="flex-row items-center flex-1">
                <View style={{backgroundColor: 'rgba(255, 255, 255, 0.2)'}} className="p-3 rounded-full mr-3">
                  <Ionicons name="add-circle" size={28} color="white" />
                </View>
                <Text className="text-2xl font-bold text-white">Новый товар</Text>
              </View>
              <TouchableOpacity
            ...
            <ScrollView style={{ paddingHorizontal: 24, paddingTop: 16 }} contentContainerStyle={{paddingBottom: 24}} showsVerticalScrollIndicator={false}>
              {/* Основная информация */}
              ...
              <View style={{ marginBottom: 24 }}>
                ...
                <View style={{ 
                  ...
                  {itemType === 'обувь' ? (
                    ...
                    >
                      <Picker.Item label="Детский (30-36)" value="детский" />
                      <Picker.Item label="Подростковый (36-41)" value="подростковый" />
                      <Picker.Item label="Мужской (39-44)" value="мужской" />
                      <Picker.Item label="Великан (44-48)" value="великан" />
                      <Picker.Item label="Общий (36-45)" value="общий" />
                    </Picker>
                  ) : (
                    <Picker
                      ...
                      dropdownIconColor={themeColors.text.normal}
                    >
                      <Picker.Item label="Международный (XS-5XL)" value="международный" />
                      <Picker.Item label="Брюки (44-60)" value="брюки" />
                    </Picker>
                  )}
                </View>
              </View>
              ...
              <View style={{ marginBottom: 12 }}>
                  ...
                  >
                    {Array.from({ length: 20 }, (_, i) => i + 1).map(num => (
                        <Picker.Item key={num} label={`${num} ${num === 1 ? 'коробка' : num < 5 ? 'коробки' : 'коробок'}`} value={num} />
                    ))}
                  </Picker>
                </View>
              </View>
                            ...
                            {item.quantity > 0 && (
                              <View style={{ 
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                  <Text style={{ fontSize: 12, color: themeColors.text.muted }}>Цена за единицу:</Text>
                                  <Text style={{ fontSize: 12, color: themeColors.text.normal, fontWeight: '600' }}>{pricePerPair.toFixed(2)} сомонӣ</Text>
                                </View>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 }}>
                                  <Text style={{ fontSize: 12, color: themeColors.text.muted }}>Итого:</Text>
                                  <Text style={{color: '#22c55e', fontSize: 12, fontWeight: 'bold'}}>{(item.quantity * pricePerPair).toFixed(2)} сомонӣ</Text>
                                </View>
                              </View>
                            )}
                          </View>
